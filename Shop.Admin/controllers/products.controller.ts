...
import { getProduct, getProducts, removeProduct, searchProducts, updateProduct, getSimilarProducts, getNotSimilarProducts, createProduct} from "../models/products.model";
